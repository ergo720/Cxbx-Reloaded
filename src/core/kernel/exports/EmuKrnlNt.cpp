...
// ******************************************************************
XBSYSAPI EXPORTNUM(184) xbox::ntstatus_xt XBOXAPI xbox::NtAllocateVirtualMemory
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(185) xbox::ntstatus_xt XBOXAPI xbox::NtCancelTimer
(
...
// * 0x00BA - NtClearEvent()
// ******************************************************************
XBSYSAPI EXPORTNUM(186) xbox::ntstatus_xt XBOXAPI xbox::NtClearEvent
(
...
// * 0x00BB - NtClose()
// ******************************************************************
XBSYSAPI EXPORTNUM(187) xbox::ntstatus_xt XBOXAPI xbox::NtClose
(
	IN HANDLE Handle
)
{
...
// ******************************************************************
XBSYSAPI EXPORTNUM(188) xbox::ntstatus_xt XBOXAPI xbox::NtCreateDirectoryObject
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(189) xbox::ntstatus_xt XBOXAPI xbox::NtCreateEvent
(
...
// * 0x00BE - NtCreateFile()
// ******************************************************************
XBSYSAPI EXPORTNUM(190) xbox::ntstatus_xt XBOXAPI xbox::NtCreateFile
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(191) xbox::ntstatus_xt XBOXAPI xbox::NtCreateIoCompletion
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(192) xbox::ntstatus_xt XBOXAPI xbox::NtCreateMutant
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(193) xbox::ntstatus_xt XBOXAPI xbox::NtCreateSemaphore
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(194) xbox::ntstatus_xt XBOXAPI xbox::NtCreateTimer
(
...
// * 0x00C3 - NtDeleteFile()
// ******************************************************************
XBSYSAPI EXPORTNUM(195) xbox::ntstatus_xt XBOXAPI xbox::NtDeleteFile
(
	IN POBJECT_ATTRIBUTES ObjectAttributes
)
{
...
// ******************************************************************
XBSYSAPI EXPORTNUM(196) xbox::ntstatus_xt XBOXAPI xbox::NtDeviceIoControlFile
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(197) xbox::ntstatus_xt XBOXAPI xbox::NtDuplicateObject
(
	HANDLE  SourceHandle,
	HANDLE *TargetHandle,
	dword_xt   Options
...
// ******************************************************************
XBSYSAPI EXPORTNUM(198) xbox::ntstatus_xt XBOXAPI xbox::NtFlushBuffersFile
(
	PVOID                FileHandle,
	OUT PIO_STATUS_BLOCK IoStatusBlock
)
...
XBSYSAPI EXPORTNUM(199) xbox::ntstatus_xt XBOXAPI xbox::NtFreeVirtualMemory
(
	IN OUT PVOID *BaseAddress,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(200) xbox::ntstatus_xt XBOXAPI xbox::NtFsControlFile
(
	IN HANDLE               FileHandle,
	IN HANDLE               Event OPTIONAL,
	IN PIO_APC_ROUTINE      ApcRoutine OPTIONAL,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(201) xbox::ntstatus_xt XBOXAPI xbox::NtOpenDirectoryObject
(
	OUT PHANDLE DirectoryHandle,
	IN POBJECT_ATTRIBUTES ObjectAttributes
)
...
XBSYSAPI EXPORTNUM(202) xbox::ntstatus_xt XBOXAPI xbox::NtOpenFile
(
	OUT PHANDLE             FileHandle,
	IN  access_mask_xt         DesiredAccess,
	IN  POBJECT_ATTRIBUTES  ObjectAttributes,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(203) xbox::ntstatus_xt XBOXAPI xbox::NtOpenSymbolicLinkObject
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(204) xbox::ntstatus_xt XBOXAPI xbox::NtProtectVirtualMemory
(
	IN OUT PVOID *BaseAddress,
...
// * 0x00CD - NtPulseEvent()
// ******************************************************************
XBSYSAPI EXPORTNUM(205) xbox::ntstatus_xt XBOXAPI xbox::NtPulseEvent
(
	IN HANDLE	EventHandle,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(206) xbox::ntstatus_xt XBOXAPI xbox::NtQueueApcThread
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(207) xbox::ntstatus_xt XBOXAPI xbox::NtQueryDirectoryFile
(
	IN  HANDLE                      FileHandle,
	IN  HANDLE                      Event OPTIONAL,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(208) xbox::ntstatus_xt XBOXAPI xbox::NtQueryDirectoryObject
(
...
// * 0x00D1  - NtQueryEvent()
// ******************************************************************
XBSYSAPI EXPORTNUM(209) xbox::ntstatus_xt XBOXAPI xbox::NtQueryEvent
(
	IN HANDLE EventHandle,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(210) xbox::ntstatus_xt XBOXAPI xbox::NtQueryFullAttributesFile
(
	IN  POBJECT_ATTRIBUTES          ObjectAttributes,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(211) xbox::ntstatus_xt XBOXAPI xbox::NtQueryInformationFile
(
	IN  HANDLE                      FileHandle,
	OUT PIO_STATUS_BLOCK            IoStatusBlock,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(212) xbox::ntstatus_xt XBOXAPI xbox::NtQueryIoCompletion
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(213) xbox::ntstatus_xt XBOXAPI xbox::NtQueryMutant
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(214) xbox::ntstatus_xt XBOXAPI xbox::NtQuerySemaphore
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(215) xbox::ntstatus_xt XBOXAPI xbox::NtQuerySymbolicLinkObject
(
	HANDLE LinkHandle,
...
// * 0x00D8 - NtQueryTimer()
// ******************************************************************
XBSYSAPI EXPORTNUM(216) xbox::ntstatus_xt XBOXAPI xbox::NtQueryTimer
(
	IN HANDLE TimerHandle,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(217) xbox::ntstatus_xt XBOXAPI xbox::NtQueryVirtualMemory
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(218) xbox::ntstatus_xt XBOXAPI xbox::NtQueryVolumeInformationFile
(
	IN  HANDLE                      FileHandle,
	OUT PIO_STATUS_BLOCK            IoStatusBlock,
...
// * 0x00DB - NtReadFile()
// ******************************************************************
XBSYSAPI EXPORTNUM(219) xbox::ntstatus_xt XBOXAPI xbox::NtReadFile
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(220) xbox::ntstatus_xt XBOXAPI xbox::NtReadFileScatter
(
	IN HANDLE FileHandle,
	IN HANDLE Event OPTIONAL,
	IN PIO_APC_ROUTINE ApcRoutine OPTIONAL,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(221) xbox::ntstatus_xt XBOXAPI xbox::NtReleaseMutant
(
	IN  HANDLE  MutantHandle,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(222) xbox::ntstatus_xt XBOXAPI xbox::NtReleaseSemaphore
(
	IN  HANDLE              SemaphoreHandle,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(223) xbox::ntstatus_xt XBOXAPI xbox::NtRemoveIoCompletion
(
	IN HANDLE IoCompletionHandle,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(224) xbox::ntstatus_xt XBOXAPI xbox::NtResumeThread
(
	IN  HANDLE ThreadHandle,
...
// * 0x00E1 - NtSetEvent()
// ******************************************************************
XBSYSAPI EXPORTNUM(225) xbox::ntstatus_xt XBOXAPI xbox::NtSetEvent
(
	IN  HANDLE EventHandle,
	OUT PLONG  PreviousState
)
...
// ******************************************************************
XBSYSAPI EXPORTNUM(226) xbox::ntstatus_xt XBOXAPI xbox::NtSetInformationFile
(
	IN  HANDLE                   FileHandle,
	OUT PIO_STATUS_BLOCK         IoStatusBlock,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(227) xbox::ntstatus_xt XBOXAPI xbox::NtSetIoCompletion
(
	IN HANDLE IoCompletionHandle,
	IN PVOID KeyContext,
	IN PVOID ApcContext,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(228) xbox::ntstatus_xt XBOXAPI xbox::NtSetSystemTime
(
...
// * 0x00E5 - NtSetTimerEx()
// ******************************************************************
XBSYSAPI EXPORTNUM(229) xbox::ntstatus_xt XBOXAPI xbox::NtSetTimerEx
(
	IN HANDLE TimerHandle,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(230) xbox::ntstatus_xt XBOXAPI xbox::NtSignalAndWaitForSingleObjectEx
(
...
// ******************************************************************
XBSYSAPI EXPORTNUM(231) xbox::ntstatus_xt XBOXAPI xbox::NtSuspendThread
(
	IN  HANDLE  ThreadHandle,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(232) xbox::void_xt XBOXAPI xbox::NtUserIoApcDispatcher
(
	PVOID            ApcContext,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(233) xbox::ntstatus_xt XBOXAPI xbox::NtWaitForSingleObject
(
    IN  HANDLE  Handle,
    IN  boolean_xt Alertable,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(234) xbox::ntstatus_xt XBOXAPI xbox::NtWaitForSingleObjectEx
(
	IN  HANDLE          Handle,
	IN  KPROCESSOR_MODE WaitMode,
	IN  boolean_xt         Alertable,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(235) xbox::ntstatus_xt XBOXAPI xbox::NtWaitForMultipleObjectsEx
(
	IN  ulong_xt           Count,
	IN  HANDLE         *Handles,
...
XBSYSAPI EXPORTNUM(236) xbox::ntstatus_xt XBOXAPI xbox::NtWriteFile
(
	IN  HANDLE          FileHandle,
	IN  HANDLE          Event,
	IN  PIO_APC_ROUTINE ApcRoutine OPTIONAL,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(237) xbox::ntstatus_xt XBOXAPI xbox::NtWriteFileGather
(
	IN HANDLE FileHandle,
	IN HANDLE Event OPTIONAL,
	IN PIO_APC_ROUTINE ApcRoutine OPTIONAL,
...
// ******************************************************************
XBSYSAPI EXPORTNUM(238) xbox::void_xt XBOXAPI xbox::NtYieldExecution()
{
